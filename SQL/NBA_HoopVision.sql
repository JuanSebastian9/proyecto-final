...
PRINT 'Creando tabla play_by_play...';
CREATE TABLE play_by_play (
    game_id NVARCHAR(50) NOT NULL,    -- ID como NVARCHAR
    eventnum INT NOT NULL,              -- Mantenemos INT
    eventmsgtype INT NULL, eventmsgactiontype INT NULL, period INT NULL,
    wctimestring NVARCHAR(20) NULL, pctimestring NVARCHAR(20) NULL,
    homedescription NVARCHAR(MAX) NULL, neutraldescription NVARCHAR(MAX) NULL,
    visitordescription NVARCHAR(MAX) NULL, score NVARCHAR(20) NULL, scoremargin NVARCHAR(10) NULL,
    person1type INT NULL, player1_id NVARCHAR(50) NULL, player1_name NVARCHAR(255) NULL, player1_team_id NVARCHAR(50) NULL,
    player1_team_city NVARCHAR(100) NULL, player1_team_nickname NVARCHAR(100) NULL, player1_team_abbreviation NVARCHAR(10) NULL,
    person2type INT NULL, player2_id NVARCHAR(50) NULL, player2_name NVARCHAR(255) NULL, player2_team_id NVARCHAR(50) NULL,
    player2_team_city NVARCHAR(100) NULL, player2_team_nickname NVARCHAR(100) NULL, player2_team_abbreviation NVARCHAR(10) NULL,
    person3type INT NULL, player3_id NVARCHAR(50) NULL, player3_name NVARCHAR(255) NULL, player3_team_id NVARCHAR(50) NULL,
    player3_team_city NVARCHAR(100) NULL, player3_team_nickname NVARCHAR(100) NULL, player3_team_abbreviation NVARCHAR(10) NULL,
    video_available_flag BIT NULL,
    PRIMARY KEY (game_id, eventnum),
    CONSTRAINT FK_pbp_game FOREIGN KEY (game_id) REFERENCES game(game_id),
    CONSTRAINT FK_pbp_player1 FOREIGN KEY (player1_id) REFERENCES player(id),
    CONSTRAINT FK_pbp_team1 FOREIGN KEY (player1_team_id) REFERENCES team(id),
    CONSTRAINT FK_pbp_player2 FOREIGN KEY (player2_id) REFERENCES player(id),
    CONSTRAINT FK_pbp_team2 FOREIGN KEY (player2_team_id) REFERENCES team(id),
    CONSTRAINT FK_pbp_player3 FOREIGN KEY (player3_id) REFERENCES player(id),
    CONSTRAINT FK_pbp_team3 FOREIGN KEY (player3_team_id) REFERENCES team(id)
);
GO
